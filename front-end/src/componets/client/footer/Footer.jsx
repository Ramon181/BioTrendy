const Footer = () => {
  return (
    <div className="w-full">
      <div className="bg-[#1F1F1F] h-[70px] flex flex-row items-center justify-center space-x-4">
        <div>
        ...
        <div>
          <a
            href=""
            class="w-full tracking-wider px-6 py-2.5 mt-6 text-sm font-bold uppercase transition-colors duration-300 transform text-white  bg-blue-600 hover:bg-blue-700 focus:bg-blue-700 rounded-md lg:w-auto  focus:outline-none "
          >
            Registrate
          </a>
        </div>
